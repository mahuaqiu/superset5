...
RUN export PIP_INDEX_URL="https://mirrors.aliyun.com/pypi/simple/"
...
RUN --mount=type=cache,target=${SUPERSET_HOME}/.cache/uv \
    if [ "$INCLUDE_CHROMIUM" = "true" ] || [ "$INCLUDE_FIREFOX" = "true" ]; then \
        export PIP_INDEX_URL="https://mirrors.aliyun.com/pypi/simple/" && export PLAYWRIGHT_DOWNLOAD_HOST="https://npmmirror.com/mirrors/playwright/" && uv pip install playwright && \
        playwright install-deps && \
        if [ "$INCLUDE_CHROMIUM" = "true" ]; then export PLAYWRIGHT_DOWNLOAD_HOST="https://npmmirror.com/mirrors/playwright/" && playwright install chromium; fi && \
